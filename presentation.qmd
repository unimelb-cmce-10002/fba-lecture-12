...
- who bears risk
- what choices people get to make
...
We care about bias beyond the statistical sense...
...
**Takeaway:**  
The question is not only "Can we model/describe/predict this?"  
...
Because the data we want rarely exists in the form we need, we must collect, clean, or reshape data from:
...
- Does the tool need to be easily interpretable?
