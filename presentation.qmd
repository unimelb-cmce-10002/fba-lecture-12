...
- T2: Uber as a two-sided platform
...
The data we want rarely exists in the form we need.

We often need to collect, clean, or reshape data from:
...
- T8: APIs and web scraping
- T6: JSON and bid data

:::

::: {.column width="47%"}

![](recap-assets/recap-05.png){width=100%}
...
To produce useful analysis, match the tool to the task.
...
- T9: k-means clustering in HRM
- T10: A/B testing in tech
...
We need to think critically about what the data really shows:
...
You will not always get a clean brief.

Business analysts need to act as curious, focused investigators:
